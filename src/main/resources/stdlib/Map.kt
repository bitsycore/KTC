...
class HashMap<K, V>(private var capacity: Int) : MutableMap<K, V> {
	...
	private var keys: @Ptr Array<K> = HeapAlloc<Array<K>>(capacity)!!
	private var vals: @Ptr Array<V> = HeapAlloc<Array<V>>(capacity)!!
	private var occ: @Ptr Array<Boolean> = HeapArrayZero<Array<Boolean>>(capacity)!!
